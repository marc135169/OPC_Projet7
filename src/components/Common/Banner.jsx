...
export default function Banner ({image, title}){
    return (
        <div className='banner'>
            {/*<div className='banner relative flex items-center justify-start h-[111px] mt-[27px] mx-5 rounded-[10px] w-[335px]
                        1xl:h-[223px] 1xl:my-8 1xl:justify-center 1xl:mx-[120px] 1xl:w-[75rem] '>*/}
